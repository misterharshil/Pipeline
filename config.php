<?php
	...
	define('BASE_URI', 'http://localhost'); # base URI for this Pipeline instance <- CHANGE THIS
	define('COOKIE_DOMAIN','localhost'); # the domain where the cookie will be available <- CHANGE THIS
	define('COOKIE_PATH','/'); # the path on the server where the cookie will be available <- CHANGE THIS
	define('PIPELINE_NAME', 'Pipe'); # name of this Pipeline instance <- CHANGE THIS
	...
	define('DB_PASSWORD', 'lmao123'); # database password <- CHANGE THIS
	define('DB_NAME', 'pipetest'); # database name <- CHANGE THIS
