...
<p>Have an account already? <a href="<?= Url::logIn() ?>">Log in here.</a> If not, create one.</p>
...
<div class="clear">
	...
	<div class="input">
		...
		<p><i>Must be valid to receive email notifications</i></p>
	</div>
</div>
<div class="clear">
...
<div class="clear">
	...
	<div class="input">
		<textarea id="txtBiography" placeholder="What are you currently pursuing? Write something about yourself.."></textarea>
